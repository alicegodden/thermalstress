...
sns.boxplot(x=x, y=y, color='red')  # Specify x and y variables
...
# set y axis range
plt.ylim(30, 75)  # Adjust the range as needed

# Save the plot as PNG
plt.savefig('boxplot_coverage_HS_gDNA_all_samples.png', dpi=600)
plt.savefig('boxplot_coverage_HS_gDNA_all_samples.pdf')
