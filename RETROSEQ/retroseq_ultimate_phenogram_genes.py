# Title: Phenogram plot with retroseq inputs
# Subtitle:
...
vcf_file = 'MC_HEADERFILTERPY_merged_with_header_USEMEBABY_win150_int_filtered.vcf'
...
plt.title('Non-reference TE Insertion mutations Testes Control', fontsize=20, fontweight='bold')
...
output_file = 'genes.png'  # Replace with your desired filename and extension
